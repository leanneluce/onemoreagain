...
urlpatterns = [
    ...
    url(r'^blog/$', posts.views.home, name="post_home"),
    url(r'^blog/(?P<post_id>[0-9]+)/$', posts.views.post_details, name="post_detail"),
    url(r'^blog/(?P<slug>[\w-]+)/$', posts.views.post_details, name="post_detail_slug"),
